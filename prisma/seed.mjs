/**
 * Prisma Seed Script (ESM-compatible)
 * Populates the Docker Postgres database with:
 *   1. The 8 predefined city zones
 *   2. A default admin user (admin@urbanverse.ai / password123)
 *
 * Run with: node --experimental-vm-modules prisma/seed.mjs
 */
import bcrypt from "bcryptjs"

// Dynamically import the Prisma Client (generated as ESM)
...
async function main() {
  ...
  if (!existingUser) {
    ...
    console.log(`  ✅ Admin user created: ${adminEmail} (password: password123)`)
  } else {
